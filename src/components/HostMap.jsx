...
const VENUES = [
  ...
  { id: 'la', city: 'Los Angeles', stadium: 'SoFi Stadium', cc: 'us', matches: 8, left: 36.9, top: 59.5 },
  { id: 'miami', city: 'Miami', stadium: 'Hard Rock Stadium', cc: 'us', matches: 7, note: 'THIRD PLACE', left: 73.8, top: 72.3 },
  ...
  { id: 'sf', city: 'San Francisco Bay Area', stadium: "Levi's Stadium", cc: 'us', matches: 6, left: 34.2, top: 55.4 },
  { id: 'seattle', city: 'Seattle', stadium: 'Lumen Field', cc: 'us', matches: 6, left: 34.0, top: 42.6 },
  // ── Canada ──
  { id: 'toronto', city: 'Toronto', stadium: 'BMO Field', cc: 'ca', matches: 6, left: 73.5, top: 47.6 },
  { id: 'vancouver', city: 'Vancouver', stadium: 'BC Place', cc: 'ca', matches: 7, left: 33.2, top: 40.3 },
  // ── Mexico ──
