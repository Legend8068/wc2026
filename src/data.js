...
const RAW_FIXTURES = {
  ...
  C: [['14.06','06:00','BRA','MAR'],['14.06','09:00','HAI','SCO'],['20.06','06:00','SCO','MAR'],['20.06','08:30','BRA','HAI'],['25.06','06:00','SCO','BRA'],['25.06','06:00','MAR','HAI']],
  D: [['13.06','09:00','USA','PAR'],['14.06','12:00','AUS','TUR'],['20.06','03:00','USA','AUS'],['20.06','11:00','TUR','PAR'],['26.06','10:00','TUR','USA'],['26.06','10:00','PAR','AUS']],
...
export const KO = [
  // LEFT SIDE - flows into M101
  { id:'M74',  round:'R32', side:'L', d:'30.06', t:'04:30', src:[{w:'E'},{t:1}] },
  { id:'M77',  round:'R32', side:'L', d:'01.07', t:'05:00', src:[{w:'I'},{t:2}] },
  { id:'M73',  round:'R32', side:'L', d:'29.06', t:'03:00', src:[{r:'A'},{r:'B'}] },
  { id:'M75',  round:'R32', side:'L', d:'30.06', t:'09:00', src:[{w:'F'},{r:'C'}] },
  { id:'M83',  round:'R32', side:'L', d:'03.07', t:'07:00', src:[{r:'K'},{r:'L'}] },
  { id:'M84',  round:'R32', side:'L', d:'03.07', t:'03:00', src:[{w:'H'},{r:'J'}] },
  { id:'M81',  round:'R32', side:'L', d:'02.07', t:'08:00', src:[{w:'D'},{t:5}] },
  { id:'M82',  round:'R32', side:'L', d:'02.07', t:'04:00', src:[{w:'G'},{t:6}] },

  // RIGHT SIDE - flows into M102
  { id:'M76',  round:'R32', side:'R', d:'30.06', t:'01:00', src:[{w:'C'},{r:'F'}] },
  { id:'M78',  round:'R32', side:'R', d:'01.07', t:'01:00', src:[{r:'E'},{r:'I'}] },
  { id:'M79',  round:'R32', side:'R', d:'01.07', t:'09:00', src:[{w:'A'},{t:3}] },
  { id:'M80',  round:'R32', side:'R', d:'02.07', t:'00:00', src:[{w:'L'},{t:4}] },
  { id:'M86',  round:'R32', side:'R', d:'04.07', t:'06:00', src:[{w:'J'},{r:'H'}] },
  { id:'M88',  round:'R32', side:'R', d:'04.07', t:'02:00', src:[{r:'G'},{r:'D'}] },
  { id:'M85',  round:'R32', side:'R', d:'03.07', t:'11:00', src:[{w:'B'},{t:7}] },
  { id:'M87',  round:'R32', side:'R', d:'04.07', t:'09:30', src:[{w:'K'},{t:8}] },

  { id:'M89',  round:'R16', side:'L', d:'05.07', t:'05:00', src:[{win:'M74'},{win:'M77'}] },
  { id:'M90',  round:'R16', side:'L', d:'05.07', t:'01:00', src:[{win:'M73'},{win:'M75'}] },
  { id:'M93',  round:'R16', side:'L', d:'07.07', t:'03:00', src:[{win:'M83'},{win:'M84'}] },
  { id:'M94',  round:'R16', side:'L', d:'07.07', t:'08:00', src:[{win:'M81'},{win:'M82'}] },

  { id:'M91',  round:'R16', side:'R', d:'06.07', t:'04:00', src:[{win:'M76'},{win:'M78'}] },
  { id:'M92',  round:'R16', side:'R', d:'06.07', t:'08:00', src:[{win:'M79'},{win:'M80'}] },
  { id:'M95',  round:'R16', side:'R', d:'08.07', t:'00:00', src:[{win:'M86'},{win:'M88'}] },
  { id:'M96',  round:'R16', side:'R', d:'08.07', t:'04:00', src:[{win:'M85'},{win:'M87'}] },

  { id:'M97',  round:'QF',  side:'L', d:'10.07', t:'04:00', src:[{win:'M89'},{win:'M90'}] },
  { id:'M98',  round:'QF',  side:'L', d:'11.07', t:'03:00', src:[{win:'M93'},{win:'M94'}] },

  { id:'M99',  round:'QF',  side:'R', d:'12.07', t:'05:00', src:[{win:'M91'},{win:'M92'}] },
  ...
  { id:'M103', round:'TP',  side:'C', d:'19.07', t:'05:00', src:[{lose:'M101'},{lose:'M102'}] },
